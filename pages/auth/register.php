    ...
    <div class="container mt-5">
        ...
        <div class=" mt-4 mb-5 d-flex justify-content-center">
            <div class="container-form px-5 py-5 ">
                <h1>Register</h1>
                <form method="POST" action="../../controller/user-registration.php">
                    <div class="mt-5">
                        <label for="name">Email</label>
                        <input class="form-control" type="text" placeholder="Email kamu..." id="emal" name="email">
                    </div>
                    <div class="mt-5">
                    ...
                    <button type="submit" name="submit" class="mt-5 py-2 btn btn-primary w-100">Submit</button>
                </form>
            </div>
